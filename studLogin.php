<html>
<head><title>Student Login Form</title></head>
...
if(isset($_POST['login']))
{
    ...
    $node= $xml->getElementsByTagName("student");
	
	foreach ( $node as $value)
	{	
		$user=$value->getElementsByTagName("StudentID")->item(0);
		$id = $user->nodeValue;
	
		$pass=$value->getElementsByTagName("Password")->item(0);
		$passw=$pass->nodeValue;
		
		$name=$value->getElementsByTagName("StudentName")->item(0);
