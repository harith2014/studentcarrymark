...
<body>
	<div id="wrapper">
		...
		<div id="header">
			...
			<div class="tagline"><p>This system is being used by lecturer and student. Any problem regarding to this system, you can contact our administrator</p></div>
		</div>
				...
				<ul>
                	<li>
                        ...
                        <ul class="blocklist">
                            ...
                            <li class="selected-item"><a href="delete_info.php">Delete Student Information</a></li>
                        </ul>
