...
?>					
				...
				<fieldset>
					...
					<form method="post" action="view_student.php" enctype="multipart/form-data">
						...
						<input type="button" name="update" value="UPDATE" onclick="location.href='update_student_lec.php?StudentID=<?php	echo $student[0]->StudentID;?>'" />
                        <input type="button" name="delete" value="DELETE" onclick="location.href='lect_delete.php?StudentID=<?php	echo $student[0]->StudentID;?>'" />
					</form>
